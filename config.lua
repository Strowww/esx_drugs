...
Config.Zones = {
    ...
    CokeProcessing      = {x=421.1989,    y=-2058.855,    z=22.275,   name = _U('coke_processing'),    sprite = 478,    color = 40},
	...
	---------------------------------------------------------------------------------------------------------------------------
	---------------------------------------------------------------------------------------------------------------------------
    WeedField           = {x=857.8062,  y=-607.0004,    z=58.056,   name = _U('weed_field'),         sprite = 496,    color = 52},
    WeedProcessing      = {x=-621.122,  y=-1156.66,   z=22.078,  name = _U('weed_processing'),    sprite = 496,    color = 52},
