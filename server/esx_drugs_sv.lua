...
local function HarvestCoke(source)
	...
	if CopsConnected < Config.RequiredCopsCoke then
		TriggerClientEvent('esx:showNotification', source, _U('act_imp_pn', CopsConnected, Config.RequiredCopsCoke))
		return
	end
...
local function HarvestCrack(source)
	...
	if CopsConnected < Config.RequiredCopsCrack then
		TriggerClientEvent('esx:showNotification', source, _U('act_imp_pn', CopsConnected, Config.RequiredCopsCrack))
		return
	end
...
local function HarvestMeth(source)
	...
	if CopsConnected < Config.RequiredCopsMeth then
		TriggerClientEvent('esx:showNotification', source, _U('act_imp_pn', CopsConnected, Config.RequiredCopsMeth))
		return
	end
...
local function HarvestMethlab(source)
	...
	if CopsConnected < Config.RequiredCopsMethlab then
		TriggerClientEvent('esx:showNotification', source, _U('act_imp_pn', CopsConnected, Config.RequiredCopsMethlab))
		return
	end
...
local function HarvestAcetone(source)
	...
	if CopsConnected < Config.RequiredCopsAcetone then
		TriggerClientEvent('esx:showNotification', source, _U('act_imp_pn', CopsConnected, Config.RequiredCopsAcetone))
		return
	end
...
local function HarvestLithium(source)
	...
	if CopsConnected < Config.RequiredCopsLithium then
		TriggerClientEvent('esx:showNotification', source, _U('act_imp_pn', CopsConnected, Config.RequiredCopsLithium))
		return
	end
...
local function HarvestKetamine(source)
	...
	if CopsConnected < Config.RequiredCopsKetamine then
		TriggerClientEvent('esx:showNotification', source, _U('act_imp_pn', CopsConnected, Config.RequiredCopsKetamine))
		return
	end
...
local function HarvestWeed(source)
	...
	if CopsConnected < Config.RequiredCopsWeed then
		TriggerClientEvent('esx:showNotification', source, _U('act_imp_pn', CopsConnected, Config.RequiredCopsWeed))
		return
	end
...
local function HarvestEcstasy(source)
	...
	if CopsConnected < Config.RequiredCopsEcstasy then
		TriggerClientEvent('esx:showNotification', source, _U('act_imp_pn', CopsConnected, Config.RequiredCopsEcstasy))
		return
	end
...
local function HarvestOpium(source)
	...
	if CopsConnected < Config.RequiredCopsOpium then
		TriggerClientEvent('esx:showNotification', source, _U('act_imp_pn', CopsConnected, Config.RequiredCopsOpium))
		return
	end
	...
	SetTimeout(Config.TimeToSell, function()
		...
		if PlayersSellingOpium[source] == true then
			...
			if poochQuantity == 0 then
				...
				elseif CopsConnected == 1 then
					xPlayer.addAccountMoney('black_money', 146)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_opium'))
				elseif CopsConnected == 2 then
					xPlayer.addAccountMoney('black_money', 147)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_opium'))
				elseif CopsConnected == 3 then
					xPlayer.addAccountMoney('black_money', 148)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_opium'))
				elseif CopsConnected == 4 then
					xPlayer.addAccountMoney('black_money', 149)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_opium'))
				elseif CopsConnected >= 5 then
					xPlayer.addAccountMoney('black_money', 150)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_opium'))
...
local function HarvestBillet(source)
	...
	if CopsConnected < Config.RequiredCopsBillet then
		TriggerClientEvent('esx:showNotification', source, _U('act_imp_pn', CopsConnected, Config.RequiredCopsBillet))
		return
	end
